...
Partial Class LandingPage
    ...
    Private Sub InitializeComponent()
        ...
        ' Panel13
        ' 
        Panel13.Controls.Add(PanelB)
        Panel13.Controls.Add(PanelC)
        Panel13.Controls.Add(CDMPic)
        Panel13.Controls.Add(PanelA)
        Panel13.Controls.Add(Panel15)
        Panel13.Controls.Add(TopPanel)
        ...
        ' PanelA
        ' 
        PanelA.BackColor = Color.FromArgb(CByte(0), CByte(82), CByte(8))
        PanelA.Location = New Point(11, 174)
        PanelA.Name = "PanelA"
        PanelA.Size = New Size(310, 154)
        PanelA.TabIndex = 2
        ' 
        ' Panel15
        ' 
        Panel15.Dock = DockStyle.Top
        Panel15.Location = New Point(0, 141)
        Panel15.Name = "Panel15"
        Panel15.Size = New Size(969, 27)
        Panel15.TabIndex = 1
        ' 
        ' TopPanel
        ' 
        ...
        TopPanel.Location = New Point(0, 10)
        ...
        Panel3.Location = New Point(689, 0)
        Panel3.Name = "Panel3"
        Panel3.Size = New Size(280, 131)
        Panel3.TabIndex = 3
        ' 
        ' Label7
        ' 
        Label7.AutoSize = True
        Label7.Font = New Font("Verdana", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label7.ForeColor = Color.FromArgb(CByte(255), CByte(199), CByte(0))
        Label7.Location = New Point(15, 64)
        Label7.Name = "Label7"
        Label7.Size = New Size(209, 54)
        Label7.TabIndex = 1
        Label7.Text = "Contact the Administrators" & vbCrLf & "for proper assistance" & vbCrLf & " regarding the matter."
        ' 
        ' Label6
        ' 
        Label6.AutoSize = True
        Label6.Font = New Font("Verdana", 11.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label6.ForeColor = Color.FromArgb(CByte(255), CByte(199), CByte(0))
        Label6.Location = New Point(15, 5)
        Label6.Name = "Label6"
        Label6.Size = New Size(245, 36)
        Label6.TabIndex = 0
        Label6.Text = "For any change in shift working " & vbCrLf & "hours: " & vbCrLf
        ' 
        ' Label5
        ' 
        ...
        DateLabel.Font = New Font("Verdana", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        DateLabel.ForeColor = Color.White
        DateLabel.Location = New Point(11, 16)
    ...
    Friend WithEvents CDMPic As PictureBox
    ...
    Friend WithEvents EndPanel As Panel
